"""Modular, sensor-agnostic application state for Raspberry Pi Pico W."""
...
class AppState:
    ...
    def __init__(self):
        ...
        self.device_id = getattr(config, "DEVICE_ID", "pico-1w")
        self.device_type = getattr(config, "DEVICE_TYPE", "rp2040")
