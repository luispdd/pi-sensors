"""Periodic telemetry sampling service for registered sensors on Raspberry Pi Pico 2 W."""
...
async def run_sensor_task(app_state, interval_s=getattr(config, "SENSOR_READ_INTERVAL_S", 2.0)):
